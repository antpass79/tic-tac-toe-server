...
import numpy as np
from Board import Board, BOARD_SIZE, EMPTY, NAUGHT, CROSS, GameResult
...
class PolicyGradientNetwork:
    ...
    def build_graph(self):
        ...
        with tf.variable_scope(self.name):
            ...
            # https://stackoverflow.com/questions/45882401/how-to-deal-with-userwarning-converting-sparse-indexedslices-to-a-dense-tensor?rq=1
            # self.responsible_outputs = tf.dynamic_partition(tf.reshape(self.output, [-1]), self.indexes)
